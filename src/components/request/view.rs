...
impl ReqView {
    ...
    pub fn header_idx_ops(&mut self, opt: IndexOperation, len: i32) {
        match opt {
            IndexOperation::Increase(x) => {
    ...
    pub fn param_idx_ops(&mut self, opt: IndexOperation, len: i32) {
        match opt {
            IndexOperation::Increase(x) => {
